   ...
   /**
    ...
    private function _notifyLeaveStatusChange(array $leaves, WorkflowStateMachine $workflow)
    {
        ...
        switch ($workflow->getAction()) {
            case 'APPROVE':
                if ($this->allApproversApproved($leaves)) {
...
//                );
    ...
    //--------------------------------------------------
   private function allApproversApproved(array $leaves): bool
    {
        foreach ($leaves as $leave) {
            // Check if the leave has been fully approved by all necessary approvers
            // Placeholder logic: Implement the actual check according to your application's schema
            if (!$this->isLeaveFullyApproved($leave)) {
                return false;
            }
        }
        return true;
    ...
    private function isLeaveFullyApproved($leave): bool
    {
        // Implement logic to check if all required approvers have approved the leave
        // Example: Check an approvals table or field
        // This is a placeholder implementation. Replace it with actual logic.
        $approvals = $this->getLeaveApprovals($leave); // Fetch approvals related to this leave
      ...
      private function getLeaveApprovals($leave): array
    {
        // Implement the method to fetch approvals for the leave
        // This is a placeholder implementation. Replace it with actual logic.
        // For example, query the database to get all approval records for this leave.

        // Example: Assuming an ORM or database query returns an array of approvals
        $approvals = []; // Replace with actual data retrieval logic
        return $approvals;
    } 
    //-------------------------------------------------
